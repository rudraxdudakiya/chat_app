...
import { Loader, LockIcon, Mail, UserIcon } from "lucide-react";
            ...
            <div className="md:w-1/2 p-8 flex items-center justify-center md:border-r border-slate-600/30">
              <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                  ...
                  <h2 className="text-2xl font-bold bg-gradient-to-r from-orange-500 via-blue-300 to-green-600 bg-clip-text text-transparent mb-2">Create Account</h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  >
                    {isSigningUp ? <Loader className="animate-spin text-center w-full h-5" /> : "Create Account"}
                  </button>
                </form>

                <div className="mt-6 text-center">
                    <Link to="/login" className="hover:rounded-full auth-link">
